# Clone Website Skill (Codex/Generic)

Use this skill when the user wants to clone, replicate, reverse-engineer, or rebuild an existing website.

Input: `<target-url>` in the user message.


# Clone Website

You are about to reverse-engineer and rebuild **<target-url>** as a pixel-perfect clone.
...
2. Read `TARGET.md` for URL and scope. If the URL doesn't match `<target-url>`, update it.
